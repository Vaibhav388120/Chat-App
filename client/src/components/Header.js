            ...
            <Box sx={{display:'flex',justifyContent:'space-between'}}>
                ...
                
                {
                    rooms.map((room)=>(
                        ...
                        <Button sx={{color:'white'}} varient='text'>{room.name}</Button>
                        </Link>
                    ))   
                }
                </Box>
                ...
                <Box>
                    {
                        ...
                        &&(
                        <> 
                        <Button sx={{color:'white'}} varient='text' onClick={createNewRoom}>
                        New Room
                        </Button>
                        <Button sx={{color:'white'}} varient='text' onClick={logout}>
                        Logout
                        </Button>
                        </>
                    )}
                    {
                        !userId && (<Button sx={{color:'white'}} varient='text' onClick={login}>
                        Login
                        </Button>)
                    }
                </Box>
